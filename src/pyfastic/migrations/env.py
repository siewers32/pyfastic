...
# print("PYTHONPATH:", sys.path)  # Debug: controleer PYTHONPATH

from pyfastic.config import settings
from pyfastic.models import *
...
def do_run_migrations(connection):
    context.configure(
        ...
        compare_type=True,  # CRUCIAAL: Hiermee ziet hij het verschil in DateTime types
    )
