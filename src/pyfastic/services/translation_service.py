...
class MarkdownTranslator:
    ...
    def translate_prompt(self, prompt, max_chunk_size=3000):
        
        # Stap 1: Splits de tekst in behapbare stukken
        chunks = self.chunk_text(prompt, max_chars=max_chunk_size)
...
if __name__ == "__main__":
    ...
    # translator.translate_file("translation_tests/small_book.md", "final_vertaling.md", max_chunk_size=1000)
